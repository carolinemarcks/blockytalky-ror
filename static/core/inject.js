...
Blockly.init_ = function() {
  ...
  // Load the sounds.
  Blockly.loadAudio_(
      ['static/media/click.mp3', 'static/media/click.wav', 'static/media/click.ogg'], 'click');
  Blockly.loadAudio_(
      ['static/media/delete.mp3', 'static/media/delete.ogg', 'static/media/delete.wav'], 'delete');
};
